...
export default function TaskList({ tasks, taskId }){
    ...
    return(
        <div className="w-full sm:w-[228px] md:w-[260px] sm:h-full relative flex-shrink-0 sm:overflow-hidden">
            ...
            <div className={`${taskListVisibility ? "flex" : "hidden sm:flex"} absolute top-10 left-1/2 -translate-x-1/2 sm:translate-x-0 sm:static w-full h-64 sm:h-full bg-gray-200 rounded-md flex-col gap-2 p-2.5 z-fixed sm:z-0`}>

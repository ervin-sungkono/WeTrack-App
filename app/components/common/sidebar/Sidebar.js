...
export default function Sidebar(){
    ...
    return(
        <section className={`sidebar fixed lg:relative ${open ? "w-[200px] lg:w-[240px]" : "w-0 lg:w-20 "} bg-white flex-shrink-0 h-full flex flex-col shadow-md z-[10000] transition-all duration-300 ease-in-out`}>
            <div className="w-full flex justify-between items-center px-4 pt-4 lg:pt-6 pb-4">  

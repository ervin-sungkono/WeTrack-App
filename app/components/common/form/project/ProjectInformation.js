                    ...
                    return(
                        <div className="w-full flex flex-col gap-6">
                            <div className="flex flex-col gap-4">
                                ...
                                {projectData.templateType === 'ai-generated' && <FormikTextarea label="Deskripsi Proyek (minimal 30 karakter)" required name="projectDescription" placeholder={"Masukkan deskripsi proyek..."} rows={4}/>}
                            </div>

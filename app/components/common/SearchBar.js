...
export default function SearchBar({ placeholder, handleSearch }){
    return(
        <div className="flex items-center px-2.5 py-1.5 md:px-4 md:py-2.5 gap-2 w-[180px] focus-within:w-56 focus-within:md:w-64 transition-[width] duration-300 ease-in-out text-dark-blue border border-dark-blue/30 rounded-lg group">
            <input 

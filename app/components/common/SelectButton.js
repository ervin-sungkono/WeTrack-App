    ...
    return(
        <div>
            <button 
                ...
                className="flex items-center gap-1 font-semibold text-xs md:text-sm text-dark-blue hover:text-basic-blue px-3 py-1.5 md:px-4 md:py-2 rounded-full focus:ring-0 focus:outline-none border border-dark-blue/30 transition-colors duration-300 ease-in-out" type="button"
            >

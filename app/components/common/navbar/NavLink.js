...
export default function NavLink({ label, href }){
    return(
        <Link
            href={href}
            className='
                relative w-full h-full px-2 md:px-4 py-4 lg:py-0 flex items-center font-medium text-sm text-dark-blue hover:text-basic-blue transition-colors duration-300

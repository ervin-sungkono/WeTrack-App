...
function FeatureCard({image, title, description}){
    return(
        <div className="rounded-xl flex flex-col justify-center items-center text-center bg-white shadow-lg p-4">
            ...
            <h1 className="text-md md:text-lg lg:text-xl font-bold mt-2 md:mt-4">
                {title}
            </h1>
...
export default function HomeLayout(){
    return (
        <div className="pt-2 xl:pt-8">
            <div className="py-4 md:py-6 xl:py-8 px-8 md:px-16 xl:px-32 flex flex-col xl:flex-row items-center justify-center xl:justify-between text-center xl:text-left">
                <div>
                    <h1 className="text-2xl md:text-3xl xl:text-4xl xl:leading-tight font-bold">
                        Solve issues efficiently, <br />
                        collaborate with powerful AI tools.
                    </h1>
                    <p className="mt-1 xl:mt-2 text-sm xl:text-md">
            ...
            <div className="bg-light-blue py-4 md:py-6 xl:py-8 px-8 md:px-16 xl:px-32 text-center xl:text-left">
                <h1 className="text-lg md:text-xl xl:text-2xl font-bold">About WeTrack</h1>
                <div className="mt-1 md:mt-2 flex items-center xl:items-start justify-center xl:justify-start">
                    <CustomLine size="md"/>
                </div>
                <p className="text-sm md:text-md mt-2 md:mt-4 w-full xl:w-4/5 opacity-80">
            ...
            <div className="py-4 md:py-6 xl:py-8 pb-10 md:pb-10 xl:pb-12 px-8 md:px-16 xl:px-32">
                <div className="flex flex-col justify-center items-center">
                    <h1 className="text-lg md:text-xl xl:text-2xl font-bold text-center">
                        Features
                    </h1>
                    <div className="mt-1 md:mt-2 flex w-full items-center justify-center">
                    <CustomLine size="md" />
                    </div> 
                    <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 md:gap-6 xl:gap-6 mt-4 xl:mt-8 w-full md:w-3/5 lg:w-1/2 xl:w-4/5">
                        <FeatureCard 

                    ...
                    {options.map(({label, value}) => (
                        <li key={value}>
                            <button
                                ...
                                onClick={() => handleSelectedUpdate({label, value})} className="block w-full text-start px-4 py-2 font-semibold disabled:bg-gray-300 disabled:text-dark-blue hover:bg-gray-100 hover:text-basic-blue transition-colors duration-300 ease-in-out"
                            >
                                {label}
                            </button>
                        </li>
